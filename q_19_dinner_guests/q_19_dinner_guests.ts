...
///////////// More Guests /////////////
const new_din_uests = ["Usman", "Faizan", "Taimur"];
...
while (din_guests.length > 2) {
  const guest = din_guests.pop();
  console.log(`Sorry, ${guest}, I can't invite you to dinner.`);
}

console.log(`I am still inviting ${din_guests[0]} and ${din_guests[1]} to dinner.`);
